...
public class Utility extends Driver{
    ...
    public static void switchToWindowByIndex(int windowIndex) {
        ...
        java.util.List<String> orderedHandles = new ArrayList<>();
    ...
    public static java.util.List<String> getElementsText(By locator) {
        ...
        java.util.List<WebElement> elems = driver.findElements(locator);
        java.util.List<String> elemTexts = new ArrayList<>();
    ...
    public static void selectRadioOrCheckbox(java.util.List<WebElement> listElement, String value) {
        String actualValue;
